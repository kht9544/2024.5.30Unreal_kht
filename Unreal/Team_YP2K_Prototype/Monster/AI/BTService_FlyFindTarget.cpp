...
#include "Monster/AI/BTService_FlyFindTarget.h"
...
UBTService_FlyFindTarget::UBTService_FlyFindTarget()
{
	NodeName = TEXT("FindTarget");
	Interval = 0.5f;
}

void UBTService_FlyFindTarget::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{

...
AABCharacter::AABCharacter()
{
	...
	HPBarWidget = CreateDefaultSubobject<UWidgetComponent>(TEXT("HPBAARWIDGET"));
	...
	static ConstructorHelpers::FClassFinder<UUserWidget> UI_HUD(TEXT("/Game/Book/Map/UI/UI_HPBar.UI_HPBar_C"));
	if(UI_HUD.Succeeded())
	{
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> WARRIOR_ANIM(TEXT("/Game/Book/Map/Blueprint/WarriorAnimBlueprint.WarriorAnimBlueprint_C"));

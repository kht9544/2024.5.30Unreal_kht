...
public:	
	...
	class UMyStatComponent* GetStatCom() {return _statCom;}

	class UMyInvenComponent* GetInvenCom(){return _invenCom;}

	class UUserWidget* GetScreenWidget(){return _screenWidget;}
